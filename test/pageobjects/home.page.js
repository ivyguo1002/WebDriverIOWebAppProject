...
class HomePage extends Page {
     ...
     */
    get welcomeMessage () { return $('marquee') }
    get linkLogOut() { return $('a=Log out') }
    get linkNewAccount() { return $('a[href="addAccount.php"]'); }
    get iframeAd() { return $('#aswift_0'); }
    ...
    clickLogOut() {
        ...
        browser.execute((ele) => { ele.remove() }, $('ins.adsbygoogle'));
