...
describe('guru99 banking project test cases', () => {
     ...
     * 1)  Go to http://www.demo.guru99.com/V4/
        ...
        Login Successfully
     */
    it('testcase1: should login with valid credentials', () => {
        LoginPage.login(data.valid.username, data.valid.password);
        expect(HomePage.welcomeMessage).toBeExisting();
        expect(HomePage.welcomeMessage).toHaveTextContaining('Welcome To Manager\'s Page of Guru99 Bank');
    ...
    it('testcase3: should log out successfully', () => {
        ...
        expect(browser.getAlertText()).toContain('You Have Succesfully Logged Out!!');
        browser.acceptAlert();
